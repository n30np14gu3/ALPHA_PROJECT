...
void c_sound_esp::draw() noexcept {
	...
	auto red = config_system.get_config().colors.esp_footsteps.r * 255;
	auto green = config_system.get_config().colors.esp_footsteps.g * 255;
	auto blue = config_system.get_config().colors.esp_footsteps.b * 255;
	auto alpha = config_system.get_config().colors.esp_footsteps.a * 255;
