...
public:
	...
	void __stdcall setup_resent(IDirect3DDevice9* device) {
		...
		colors[ImGuiCol_FrameBgHovered] = ImVec4(0.10f, 0.25f, 0.35f, 1.00f);
		colors[ImGuiCol_FrameBgActive] = ImVec4(0.11f, 0.30f, 0.41f, 1.00f);
		...
		colors[ImGuiCol_ScrollbarGrab] = ImVec4(0.81f, 0.09f, 0.40f, 1.00f);
		colors[ImGuiCol_ScrollbarGrabHovered] = ImVec4(0.87f, 0.07f, 0.42f, 1.00f);
		colors[ImGuiCol_ScrollbarGrabActive] = ImVec4(0.88f, 0.06f, 0.41f, 1.00f);
		colors[ImGuiCol_CheckMark] = ImVec4(0.81f, 0.08f, 0.40f, 1.00f);
		colors[ImGuiCol_SliderGrab] = ImVec4(0.81f, 0.09f, 0.40f, 1.00f);
		colors[ImGuiCol_SliderGrabActive] = ImVec4(0.10f, 0.22f, 0.31f, 1.00f);
		...
		colors[ImGuiCol_SeparatorHovered] = ImVec4(0.81f, 0.09f, 0.40f, 1.00f);
		colors[ImGuiCol_SeparatorActive] = ImVec4(0.81f, 0.09f, 0.40f, 1.00f);
		...
		colors[ImGuiCol_TextSelectedBg] = ImVec4(0.13f, 0.32f, 0.47f, 0.56f);
